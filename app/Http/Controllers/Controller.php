...
class Controller extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $popular_post = Blog::where('is_popular', true)->take(setting('page.footer.column3_popular_post_title_number'))->get();
        $featured_post = Blog::where('is_featured', true)->take(setting('page.footer.column2_recent_post_number'))->get();
